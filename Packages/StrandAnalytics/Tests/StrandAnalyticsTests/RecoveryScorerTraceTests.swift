...
final class RecoveryScorerTraceTests: XCTestCase {
    ...
    func testTraceFixtureIsByteIdenticalAcrossPlatforms() {
        ...
        XCTAssertEqual(lines, [
            ...
            "charge term rhr z=1.33 w=0.05 (lower RHR is better)",
            ...
            "charge renorm totalWeight=0.85 compositeZ=1.48 (z = sum(z*w)/sum(w))",
            "charge score=94.24 band=green (logistic k=1.34 z0=-0.61)",
        ])
    }
}
