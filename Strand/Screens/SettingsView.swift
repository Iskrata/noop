    ...
    private var unitsCard: some View {
        SettingsSection(
            ...
            VStack(spacing: 0) {
                ...
                Text("Scores Effort on an exponential intensity curve (Banister TRIMP) instead of the default curve fitted to your WHOOP Day Strain, which earns load from 40% of your heart-rate reserve upward. The exponential curve weights short, hard efforts far more heavily. Re-scores your history. Off by default.")
                    .font(StrandFont.caption)
                    .foregroundStyle(StrandPalette.textTertiary)
                    .fixedSize(horizontal: false, vertical: true)
            }
